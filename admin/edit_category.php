...
if(isset($_POST['update'])){
    ...
    if(isset($_FILES['image']) && $_FILES['image']['error']==0){
        ...
        if(in_array($ext,$allow)){
            ...
            if($image_name != "" && file_exists("../uploads/categories/".$image_name)){
...
/* ===== Current Category Preview Strip ===== */
...
<div class="page-wrap">
    ...
    <div class="page-header">
        ...
        <div class="header-text">
            ...
            <div class="breadcrumb">
                ...
                <span class="current">تعديل التصنيف</span>
            ...
            <p class="desc">قم بتعديل بيانات التصنيف ثم احفظ التغييرات.</p>
    ...
    <div class="current-card">
        ...
        <div class="info">
            ...
            <div class="label">التصنيف الحالي</div>
    ...
    <div class="layout">
                ...
                <div class="group">
                    ...
                    <label class="image-box" id="imageBox" tabindex="0">
                        ...
                        <div class="upload-hint">
                            ...
                            <span>اضغط أو اسحب لتغيير الصورة</span>
        ...
        <div class="sidebar">
            ...
            <div class="preview-card">
                ...
                <div class="preview-name" id="previewSideName"><?php echo $category['name']; ?></div>

                <div class="preview-desc">هكذا سيظهر التصنيف بعد حفظ التعديلات.</div>
            ...
            <div class="tip-card">
                ...
                <ul>
                    ...
                    <li><i class="fa-solid fa-check"></i> اترك حقل الصورة فارغاً للاحتفاظ بالصورة الحالية.</li>
...
function previewImage(event){
    ...
    reader.onload = function(){
        ...
        currentThumb.src = reader.result;
...
const currentCardName = document.querySelector(".current-card .info .name");
...
nameInput.addEventListener("input",function(){
    ...
    if(val.length > 0){
        ...
        currentCardName.textContent = val;
        ...
        nameHint.textContent = "اسم التصنيف مطلوب";
